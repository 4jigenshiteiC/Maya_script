...
class addNoiseWindow(object):
	...
	def create(self):
		...
		#	Layout　Select Layer
		cmds.frameLayout( l="Select Layer", w=self.width )
		#cmds.rowColumnLayout( nc=1 )
		self.SelectLayer1 = cmds.radioButtonGrp( nrb=1, label="BaseAnimation ", sl=1, w=self.width )
		self.SelectLayer2 = cmds.radioButtonGrp( nrb=1, scl=self.SelectLayer1, label="New AnimLayer " )
		self.SelectLayer3 = cmds.radioButtonGrp( nrb=1, scl=self.SelectLayer1, label="Steamelect AnimLayer " )
		
		cmds.rowColumnLayout( nc=3, cw=[[1, self.width /3], [2, self.width /3], [3, self.width /3]])
		cmds.text("")
		self.SteamelectAnimLayer = cmds.optionMenu()
		...
		#	Layout　Frame Range
		cmds.frameLayout( l="Frame Range", w=self.width )
		...
		#	Layout　transform
		cmds.frameLayout( l="transform", w=self.width )
		cmds.rowColumnLayout(  nc=1 )
		...
		cmds.columnLayout()
		cmds.frameLayout( l="noise setting", w=self.width, cll=False, cl=False)
		...
		#	Layout　Impact
		cmds.frameLayout( l="Impact", w=self.width)
